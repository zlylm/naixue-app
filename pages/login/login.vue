		...
		methods:{
			...
			getUserInfo(e){
				...
				if(errMsg !== "getUserInfo:ok") {
					...
					const memberInfo = Object.assign(Member,{avatar, city, country, gender, nickname, province})
					this.SET_USER_INFO(memberInfo)
					this.SET_IS_LOGIN(true)
					uni.setStorageSync('isLogin',true)
					uni.setStorageSync('userInfo',JSON.stringify(memberInfo))
					uni.navigateBack()
				}
			}
		}
